---
title: "View my hiking trail: Posiciones Veleta to Refugio Elorrieta (2016-Aug)"
output: 
...
```{r readData}
# Read gpx file 
gpxUrl <- 'https://rawgit.com/ajpelu/hiking/master/data/2016_08_tajosVirgen_elorrieta.GPX'
# temp <- tempfile(fileext = ".GPX")
# download.file(gpxUrl, temp)
# mygpx <- dir(tempdir(), "*.GPX$")

my_points <- readOGR(gpxUrl, layer = 'track_points', verbose = FALSE)
mytrack <- readOGR(gpxUrl, layer = 'tracks', verbose = FALSE) 
```
