---
title: "View my hiking trail: Cortijo del Hornillo-Vereda Estrella (2017-Jan)"
output: 
...
mygpx <- paste0(mymachine, 'Dropbox/EXCURSIONES/georoutes/ExcursionHHNN.GPX')
...
mymap <- leaflet() %>% 
  ...
  addWMSTiles('http://www.ideandalucia.es/wms/mta10r_2001?',
              layers = 'mta10r',
  ...
  addLayersControl(position = 'bottomright',
                   ...
                   baseGroups = c("OpenTopoMap", "Topographical","Ortophotography 2009"),
